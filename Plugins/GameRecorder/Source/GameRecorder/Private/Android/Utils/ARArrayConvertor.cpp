...
#include "ARArrayConvertor.h"

jobjectArray ARArrayConvertor::ConvertToJStringArray(const TArray<FString>& stringArray)
{
...
jbooleanArray ARArrayConvertor::ConvertToJBooleanArray(const TArray<bool>& boolArray)
{
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
...
jintArray ARArrayConvertor::ConvertToJIntArray(const TArray<int>& intArray)
{
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
...
jbyteArray ARArrayConvertor::ConvertToJByteArray(const TArray<uint8>& byteArray)
{
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
...
jlongArray ARArrayConvertor::ConvertToJLongArray(const TArray<long>& longArray)
{
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
...
TArray<uint8> ARArrayConvertor::ConvertToByteArray(jbyteArray javaArray)
{
...
TArray<long> ARArrayConvertor::ConvertToLongArray(jlongArray javaArray)
{
...
TArray<FString> ARArrayConvertor::ConvertToStringArray(jobjectArray javaStringArray)
{
...
jstring ARArrayConvertor::GetJavaString(FString string)
{
...
FString ARArrayConvertor::FromJavaString(jstring javaString)
{
