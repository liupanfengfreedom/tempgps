...
public class VideoProvider {
    ...
    private static final File RECORDINGS_DIR = new File(Environment.getExternalStorageDirectory().getPath(), "Moviesfile");//SettingsProvider.STORAGE_MP4_FOLDER_NAME);
    ...
    private String formatDuration(Context c, long time) {
               String lv = "video_length" + DateUtils.formatElapsedTime(time / 1000);
        return lv;
    }
