...
//public class GPSTracker extends Service implements LocationListener {
 public  class GPSTracker implements LocationListener {
    ...
    public static GPSTracker getsingltoninstance(Context context)
    {
        if(mgpstracker==null)
        {
    ...
    private static final long MIN_TIME_BW_UPDATES = 2000 * 1 * 1; // 1 secend
                ...
                if (isNetworkEnabled) {
                    ...
                    if (locationManager != null) {
                        ...
                        if (location != null) {
                            ...
                            // MainActivity.toast(s1 + "   " +s2+"  thread");
                        }
                    }
                }
    ...
    public void onLocationChanged(Location locationp) {
        ...
        // MainActivity.toast("Latitude:"+s1+"     "+"Longitude"+s2);
